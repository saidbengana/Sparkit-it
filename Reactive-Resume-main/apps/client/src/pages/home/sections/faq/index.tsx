...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@Spark-It/ui";
  ...
  <AccordionItem value="2">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        <a href="https://opencollective.com/Spark-It">
  ...
  <AccordionItem value="3">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        <a
          href="https://github.com/AmruthPillai/Spark-It/issues/new/choose"
          target="_blank"
          rel="noreferrer"
        >
          GitHub
    ...
    <AccordionItem value="4">
      ...
      <AccordionContent className="prose max-w-none dark:prose-invert">
        ...
        <div className="flex flex-wrap items-start justify-start gap-x-2 gap-y-4">
          {languages.map((language) => (
            <a
              ...
              href={`https://crowdin.com/translate/Spark-It/all/en-${language.editorCode}`}
              target="_blank"
              rel="noreferrer"
            >
        ...
        <p>
          ...
          <a href="https://crowdin.com/project/Spark-It" rel="noreferrer" target="_blank">
