...
import { AuthProvidersDto, LoginDto, RegisterDto, UserWithSecrets } from "@Spark-It/dto";
import { ErrorMessage } from "@Spark-It/utils";
...
export class AuthService {
  ...
  async forgotPassword(email: string) {
    ...
    const subject = "Reset your Spark-It password";
  ...
  async setup2FASecret(email: string) {
    ...
    const uri = authenticator.keyuri(email, "Spark-It", secret);
